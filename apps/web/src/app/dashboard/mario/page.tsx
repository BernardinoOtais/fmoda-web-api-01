...
const MarioPaginaInicial = async () => {
  ...
  let saudacao = "Boa noite, Mário 🌙"; // valor por defeito
  if (hora < 12) {
    saudacao = "Bom dia, Mário ☀️";
  } else if (hora < 18) {
    saudacao = "Boa tarde, Mário 🌤️";
  }
...
export default MarioPaginaInicial;
