...
type AutoCompleteFormFieldProps<T extends FieldValues> = {
...
export function AutoCompleteFormField<T extends FieldValues>({
  form,
  name,
  options,
                    ...
                    {options.map((option) => (
                      <CommandItem
                        ...
                        onSelect={() => {
                          form.setValue(
                            name,
                            Number(option.value) as PathValue<T, Path<T>>
                          );
